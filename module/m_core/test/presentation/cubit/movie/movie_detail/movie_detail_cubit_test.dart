...
import 'package:m_core/src/domain/usecases/get_movie_detail.dart';
import 'package:m_core/src/domain/usecases/get_watchlist_status.dart';
import 'package:m_core/src/domain/usecases/remove_watchlist.dart';
import 'package:m_core/src/domain/usecases/save_watchlist.dart';
...
void main() {
  ...
  late MovieDetailCbt cubit;
  setUp(() {
    mockGetMovieDetail = MockGetMovieDetail();
    mockGetWatchListStatus = MockGetWatchListStatus();
    mockSaveWatchlist = MockSaveWatchlist();
    mockRemoveWatchlist = MockRemoveWatchlist();
    cubit = MovieDetailCbt(
