...
import '../../presentation/cubit/tv/tv_series_detail_cbt.dart';
import 'tv_episode_season_page.dart';
import '../cubit/tv/tv_series_recommendations_cbt.dart';
...
class _TVDetailPageState extends State<TVDetailPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<TVSeriesDetailCbt>().get(widget.id);
      context.read<TVSeriesRecommendationsCbt>().get(widget.id);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SizedBox.expand(
        child: BlocBuilder<TVSeriesDetailCbt, TVSeriesDetailState>(
          builder: (_, state) {
...
class _DetailContentState extends State<DetailContent> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      context.read<TVSeriesDetailCbt>().getWatchlistStatus(widget.tv.id);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        widget.tv.posterPath == null ? Image.asset("assets/not-found.png") :
        CachedNetworkImage(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocBuilder<TVSeriesDetailCbt, TVSeriesDetailState>(
                              builder: (_, state) {
                                return ElevatedButton(
                                  onPressed: () async {
                                    if (!state.isAddedToWatchlist) {
                                      await context
                                          .read<TVSeriesDetailCbt>()
                                    ...
                                    final message =
                                        context.read<TVSeriesDetailCbt>().state.messageWatchlist;

                                    if (message == TVSeriesDetailCbt.watchlistAddSuccessMessage ||
                                        message ==
                                            TVSeriesDetailCbt.watchlistRemoveSuccessMessage) {
                                    ...
                                    return Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: season.posterPath == null ? Image.asset("assets/not-found.png") :
                                          CachedNetworkImage(
                                            fit: BoxFit.cover,
                                            imageUrl:
                            ...
                            BlocBuilder<TVSeriesRecommendationsCbt, TVSeriesRecommendationsState>(
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: recommendation.posterPath == null ? Image.asset("assets/not-found-small.png"): CachedNetworkImage(
                                                imageUrl:
